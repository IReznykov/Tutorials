...
{
	/// <summary>
	/// Configure Swagger for API description.
	/// </summary>
	public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
						...
						c.RootUrl(req => @"https://completedataapi.azurewebsites.net/");
						...
						c.SingleApiVersion("v1", "DataApi")
							.Description("Azure API App that encapsulates data source and provides REST API to external consumers such that Web or API apps, and even its own web jobs.")
							.Contact(contact =>
							{
								contact.Email("ireznykov@hotmail.com");
								contact.Name("Illya Reznykov");
								contact.Url("https://ireznykov.com");
							});
		...
		{
			return $"{AppDomain.CurrentDomain.BaseDirectory}\\bin\\DataApi.XML";
		}
	}
}
